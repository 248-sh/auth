...
export const createNativeRegistrationFlow = async (
  request: Simplify<
    OASRequestParams<Kratos, "/self-service/registration/api", "get">
  >
): Promise<Success | Failure> => {
  const response = await kratos["/self-service/registration/api"].get(request);
